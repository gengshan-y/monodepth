...
parser.add_argument('--name',type=str,default='sup-clf-100-depth')
...
pred_disp_path = '/scratch/gengshay/tmp/%s/disparities.npy' % args.name
min_depth = 1e-3
max_depth = 80

#bins = np.linspace(1e-3,80.,num=100)
bins = np.logspace(np.log(min_depth),np.log(max_depth),num=args.nbins,base=np.e)
